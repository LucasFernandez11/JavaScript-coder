...
class Personajes {
    ...
    PersonjesInfo(e) {
        let info = `<div style="display: flex; flex-direction: column; font-size: 30px; margin-top:30px; margin-left: 20px;
        margin-right: 20px; background-color:rgba(0, 100, 78, 0.822);">    
    <p style= "color:white;">Nombre: ${e.nombre}</p>
    <p style= "color:green;">Vida: ${e.vida}</p>
    <p style= "color:darkred;">Ataque: ${e.ataque}</p>
    <p style= "color:blueviolet;">Defensa: ${e.defensa}</p>
    <p style= "color:darkblue">Tipo: ${e.tipo}</p>
    </div>`; 
       return(info)
    };
};
